...
_APP_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))   # .../plataforma/app
_SRC_DIR = os.path.dirname(os.path.dirname(_APP_DIR))                    # .../src

PATHS = {
    'project_root': _APP_DIR,
    'data_dir': os.path.join(_APP_DIR, 'nlp', 'datasets'),
    'models_dir': os.path.join(_APP_DIR, 'nlp', 'models'),
    'evaluation_dir': os.path.join(_APP_DIR, 'nlp', 'evaluation', 'results'),
    'logs_dir': os.path.join(_APP_DIR, 'nlp', 'logs'),
    # O corpus e unico no repositorio e vive em src/dados. A plataforma nao guarda
    # copia propria: uma segunda copia ja divergiu da do artigo uma vez.
    'corpus_file': os.path.join(_SRC_DIR, 'dados', 'corpus.csv')
}
