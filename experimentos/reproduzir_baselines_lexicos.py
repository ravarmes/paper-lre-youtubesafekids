"""Reproduz os baselines lexicos (Lexico simples + SentiLex-PT) no holdout de 20%.

Origem: _baselines/run_lexicon_baselines.py do projeto do autor; caminhos adaptados
para este repositorio. Rodar com o venv: .venv/Scripts/python.exe
"""
import re
import json
...
from caminhos import CORPUS, RESULTADOS, SENTILEX as SENTILEXPT, prepara_saidas
...
with open(RESULTADOS / "baseline_lexico.json", "w", encoding="utf-8") as f:
...
with open(RESULTADOS / "baseline_sentilexpt.json", "w", encoding="utf-8") as f:
